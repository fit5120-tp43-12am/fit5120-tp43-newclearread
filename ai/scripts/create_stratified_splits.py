...
under the local training workspace.
"""
...
DEFAULT_SOURCE_DIR = Path(
    r"C:\Users\Aufb\Desktop\fit5120\iteration1\data\final_lora_data\outputs"
    r"\final_dataset_v1_training_system_clean\accepted"
)
