...
def build_report(metrics: dict[str, Any], rows: Sequence[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "",
        "The table below is the stratified candidate set selected by the script. The stage should replace or extend this section with completed manual labels before final submission.",
        "",
        markdown_table(
