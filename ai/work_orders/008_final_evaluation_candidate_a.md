...
C:\Users\Aufb\Desktop\fit5120\iteration1\training\logs\decisions\central_review_worker_007.md
...
```text
C:\Users\Aufb\Desktop\fit5120\iteration1\training\data\splits\test.jsonl
```
...
python scripts/evaluate_final_test_candidate_a.py --config configs/train_llama31_8b_qlora_candidate_a.yaml --adapter-path models/adapters/full_candidate_a_3epoch --data-path data/splits/test.jsonl --output-dir outputs/evaluation/candidate_a_test --allow-heldout-test
```
