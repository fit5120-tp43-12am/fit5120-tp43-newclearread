...
Your task is to read one assignment-or-rubric text and produce a short, faithful summary in simple English.
...
5. Focus on the assignment purpose, the main expectations, and the most important scoring or completion requirements.
6. Do not invent course names, grading policies, or instructions that are not present in the source text."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Generate SFT outputs for assignment_rubric samples.")
    parser.add_argument("--input", type=Path, default=base_dir / "assignment_rubric_150_samples.jsonl")
    parser.add_argument("--raw-output", type=Path, default=base_dir / "assignment_rubric_150_outputs.jsonl")
    parser.add_argument("--sft-output", type=Path, default=base_dir / "assignment_rubric_150_sft.jsonl")
    parser.add_argument("--meta-output", type=Path, default=base_dir / "assignment_rubric_150_sft.meta.json")
