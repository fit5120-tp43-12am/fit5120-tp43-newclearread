...
`C:\Users\Aufb\Desktop\fit5120\iteration1\training\work_orders\005_run_llama_smoke_test.md`

## Commands Run

From WSL inside conda env `clearread-llama-lora` and project directory `/mnt/c/Users/Aufb/Desktop/fit5120/iteration1/training`:
...
python scripts/train_smoke_qlora.py --config configs/smoke_llama31_8b_qlora.yaml
...
- Adapter path: `C:\Users\Aufb\Desktop\fit5120\iteration1\training\models\adapters\smoke_llama31_8b_qlora`
- Smoke log: `C:\Users\Aufb\Desktop\fit5120\iteration1\training\logs\smoke_test_001.md`
- Run report: `C:\Users\Aufb\Desktop\fit5120\iteration1\training\reports\SMOKE_TRAINING_RUN_REPORT.md`
...
- Inference command: `python scripts/run_inference_check.py --config configs/smoke_llama31_8b_qlora.yaml --num-examples 3`
- Examples checked: `3`
- Schema pass count: `3`
- Result: `ok`
