...
`C:\Users\Aufb\Desktop\fit5120\iteration1\training\work_orders\006_train_candidate_a_3epoch.md`
...
python scripts/train_full_qlora.py --config configs/train_llama31_8b_qlora_candidate_a.yaml --dry-run
python scripts/train_full_qlora.py --config configs/train_llama31_8b_qlora_candidate_a.yaml
...
All training/inference commands were run in WSL env `clearread-llama-lora` from `/mnt/c/Users/Aufb/Desktop/fit5120/iteration1/training` with the project-local Hugging Face cache variables.
