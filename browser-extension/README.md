...
This folder contains the Manifest V3 Clearead Chrome extension. It includes the pasted-text Summary workflow, user-triggered readable page tools, a local right-click dictionary flow for ordinary webpages, a direct link back to the Clearead website, and packaged extension icons.
