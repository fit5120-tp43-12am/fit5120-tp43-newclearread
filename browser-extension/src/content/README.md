...
The script owns page-level behavior for readable font support, the reading ruler overlay, and the small local dictionary popover. It does not scan webpages automatically, collect page text, send page content to the backend, or persist state across reloads.
